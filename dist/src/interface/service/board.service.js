...
const firebase_column_repository_1 = require("src/infrastructure/repositories/firebase-column.repository");
const firebase_task_repository_1 = require("src/infrastructure/repositories/firebase-task.repository");
const firebase_commentAndFile_repo_1 = require("src/infrastructure/repositories/firebase-commentAndFile.repo");
const kanban_task_entity_1 = require("src/domain/entities/kanban/kanban.task.entity");
const collaboration_comment_entity_1 = require("src/domain/entities/collaboration/collaboration.comment.entity");
const collaboration_attachement_entity_1 = require("src/domain/entities/collaboration/collaboration.attachement.entity");
const collaboration_taskView_entity_1 = require("src/domain/entities/collaboration/collaboration.taskView.entity");
const firebase_viewTask_repository_1 = require("src/infrastructure/repositories/firebase-viewTask.repository");
